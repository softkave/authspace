...
import {UnassignEndpoint} from './types';
import {unassignJoiSchema} from './validation';

const unassign: UnassignEndpoint = async (context, instData) => {
  const data = validate(instData.data, unassignJoiSchema);
